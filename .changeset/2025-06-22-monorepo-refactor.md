...
"@a-little-world/little-world-design-system-native": patch
---
...
2. **Update imports** (if you were importing tokens directly):
   ```typescript
   // OLD
   import { colors, spacing } from '@a-little-world/little-world-design-system';

   // NEW
   import { colors, spacing } from '@a-little-world/little-world-design-system-core';
   ```
